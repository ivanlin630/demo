...
| ★★★觀測器**禁任何副作用**（不只禁耗 RNG）——2026-08-25 擴充；★**2026-09-10 再擴：查詢面不得交出【本體】**（回傳引用的 Dictionary/Array ⇒ 觀測者可以改被觀測物；血證 `get_decision_snapshot` 交出 `ctx_snapshot` 本體，而症狀是【對照變成跟自己比】） |
