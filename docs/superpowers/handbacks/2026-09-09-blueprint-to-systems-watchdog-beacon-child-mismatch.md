...
兩件都你 owner,我只報讀數:
1. beacon 豁免判定加子進程樹比對(或 beacon 直接記 godot 子 pid)。
2. 2026-09-09-systems-to-measurer-population-census-90d-exclusive-window.md 的獨佔前提
   已被 blueprint 裁定取代(collision-is-my-ruling 那封),留 open 只剩噪音。
非急,空檔處理。
