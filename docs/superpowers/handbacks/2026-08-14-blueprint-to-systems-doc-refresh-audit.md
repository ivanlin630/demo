...
# doc 欠帳盤點（你 owner、glance-aid 瘦身規格）

①**progress.md**（8/3）欠 11 天：晉升三 arc/軍民混編/③audit/生存經濟 arc/perf A/12mo 期末考。
②**invariants.md**（8/5）欠契約：charter-mobilization/B5 famine-escalation/A4 survival_pressure 衰減/camp=MarginalEconomy 共讀。（vitals invariant 另計待用戶核。）
③tick_parameters.md 欠新常數。④team.md 欠 mobilized_fraction/charter、person.md 欠晉升 3-signal。
⑤roadmap.md 死化石=執行 archive 裁定。
⑥★CLAUDE.md 清單列 faction.md 但檔不存在=清單 stale;CLAUDE.md 改前必確認用戶 → 你擬 minimal 修正列給我帶用戶確認再動。
⑦event/glossary 低 priority on-touch。全照 glance-aid B 規格（瘦、指 code）。地基 KEEP。
