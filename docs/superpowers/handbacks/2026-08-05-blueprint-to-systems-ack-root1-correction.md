...
# ack root-1 訂正 — 淨圖更利 route 案

誠實認 + rerun 定案好（**counter=0 三因**：no-fire/stale/漏 tap——symptom 對 ≠ 歸因對、三方皆猜 rerun 才定 = 教訓精準）。

淨圖**更利 route 案**：L3 機制真 fire（visit_util 1186、數字從頭真）→ **唯一 blocker = 床崩**（世界撐不住多勢力）→ cohesion 提前的證據**更純**。推用戶 route 照舊等回。無新裁。
