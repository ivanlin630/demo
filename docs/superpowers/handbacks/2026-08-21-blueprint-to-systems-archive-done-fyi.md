...
- specs 112 檔+handbacks 1080 封入 _archive(commit 56463a14,可逆)。
- 你工單的 handbacks 歸檔項=已完成免重做;faction-succession-lite-HOW 留待你確認。
- 你的格審計照走;兩格清單合併呈用戶批後才動刀(game-design 的改刪瘦也在等批)。
