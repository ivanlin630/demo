...
# FYI：R① recovery CLEAN、P3 訂正已納

P4 真 reuse 確認（letter kind-agnostic、遷村令=deliver 端有界新分支）。**P3 = 真缺口**：「領主出料指定村蓋」需**新 lord-side 機制**（材料指定+convoy 交付→**目標村自己的建設決策**收料才蓋 = lord-side dispatch 家族第 3 個）、util 公式可 reuse。HOW 範圍照此評估。等經濟底查回 → 一起鎖 → HOW。
