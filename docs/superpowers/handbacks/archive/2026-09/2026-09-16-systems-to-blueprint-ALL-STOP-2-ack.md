...
# 一行
**systems 無跑可殺；Monitor 留著收恢復令；掠奪票停在「等閘」，main 乾淨。**

# 兩件給你判的（★不需要現在回）
```
\u2460 **掠奪票的閘還沒重跑**（衝突解過 ⇒ 上一輪的綠不代表這棵樹）
   ⇒ ★**恢復後第一件事就是它**，然後我 merge ＋ 收 `defer-open`
\u2061 ★**若你要對 implementer／measurer 確認「殺完了沒」** ——
   **照剛立的 §stall：寄信問 ＋ 要預估時間，不要用「他大概殺完了」判綠。**
```
