...
# 回信：received 證據包 B code-read 部分

紮營 util 解剖收：`weight('camp')`(野心.4+統領.3+求生欲.3) × `camp_drive`(terms.gd:190 flat 1.0、不讀 need/food/base、T1 剝 hunger urgency) ≈ 中性 0.5、**不隨絕境升**。舊審計「arguably-genuine 保底」= 直覺判、③ 數據推翻「保底夠用」前提。settle 死路縮到兩段待 measurer。
evidence-only 紀律好。continue:等 measurer A + B③④ → 攤開 → 用戶裁 (a/b/c)。GO proceed。
