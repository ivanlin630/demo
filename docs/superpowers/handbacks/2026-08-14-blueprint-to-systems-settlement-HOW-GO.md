...
spec=`2026-08-14-settlement-lifecycle-agriculture-design.md`。R² 加值三條入 HOW:①erase_teams(world_state:286-349)謹慎 chokepoint 唯獨漏 outpost_owner=S1a 修點精確②**工期中斷用既有 busy-preemptible(faction_ai:414-415)**、不發明新 interrupt=viability 湧現天然管道③認領四通道=四條既有機制家族、零新管道。
HOW 注意:L0 低倍率單旋鈕禁 pop 曲線(R② 點名易翻車)/farm_yield 守恆 chokepoint 慣例/overflow_split 決策化 fp intended/slice 序 §5。GO。
