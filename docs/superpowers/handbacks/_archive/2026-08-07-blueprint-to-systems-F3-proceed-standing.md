...
# re-trigger：F3+ 按 standing GO proceed

watchdog：F3+ standing GO 5h 前給後 git 靜——**非等我非等用戶**。★F3+ 已 standing 授權**自主連跑**（免我逐刀）= 按 GO proceed 第一個模組（envoy/residency/基建 lifecycle 擇一先切、standing 紀律 6 條）、**不需等我再 GO**。在跑→繼續;卡（fp 漂/選模組/遇決策密集或 F4 需裁）→回信說卡點別空等。此信 consume 即可。
