...
## 4b. 看守-暴動 = trade-off dial（非雙固定稅）+ named 個性層（2026-07-03 補）

**看守是「買下」暴動風險的 dial，兩者不是兩筆固定稅**：
```
暴動風險 = 基礎壓力（待遇苛度 × morale）÷ 看守強度
看守足 → 壓成低殘餘（守衛=人力機會成本）；省看守 → 爆
```
- **同化路 = 買斷**：morale 升 → 壓力遞減 → 看守可遞減 → 自由民=歸零。
- **奴役路 = 租**：鎖死希望 → morale 永低 → 基礎壓力恆在 → 看守永付才壓得住。勞動產出恆收、看守+殘餘風險恆付。
- **戰時暴動窗**：守衛被抽去打仗 → 看守比崩 → 奴隸趁虛暴動（湧現，不用劇本）。guard-cap 既有。

**named 個性層**：named 俘虜/奴隸壓力 = f(待遇, 人格)——**剛烈/高野心/高義氣 → 寧死不為奴**（絕食/尋死/不停試逃，看守壓不住個人）；忍辱型苟活。
- **頭目效應**：寧死不屈 named 混在 anon cohort = 煽動者，拉高整 cohort 壓力（named morale 餵 cohort 壓力 term）→ 主人 believable 決策：誅首惡（賠口碑）/單獨賣放。
- **復仇弧**：高野心 named 被奴 → 逃 → vendetta 回頭（G2 既有）。
- 未來鉤：忠義被奴→正統/口碑放大代價（維度4）、異文化奴役→文化仇恨。
- 零新判斷器：named values 既有、壓力公式多讀一項。
