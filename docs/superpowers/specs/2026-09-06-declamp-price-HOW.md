...
| 3 | ★**第四桶（`shortage < -1`）的實測值**：它非 0 ＝「**白送區真的存在**」（blueprint：**有戲不是 bug**）。<br>★★★**而方向訂正後它更重要**：`shortage < -1` ＝ **stock > 2×target** ＝ **深度過剩** ⇒ **拆後那些貨的價格【直接是 0】**。★**若 food 落在這一桶的比例高 ⇒ 農隊賣糧收入歸零** ⇒ **那是 regime change，不是價格波動** |
...
★★★而【D 格的命中率讀數要先有】—— 它是【拆前安全讀數】:
   下界命中率【高】⇒ ★★★【過剩】側正在被閥扛著 ⇒ 先治上游再拆
     ——【2026-09-06 訂正方向詞】:撞【下界】= shortage < -0.5 = 【stock > 1.5×target】= ★過剩,不是短缺
     ⇒ ★閥在扛的是【過剩 → 價格塌】,而【我與 blueprint 先前都寫成「短缺迴圈」是錯的】
     ⇒ ★★而它改變了【拆的風險長什麼樣】:拆後 floor 0 ⇒ 【glut 品直奔白送區(價格 0)】
        ⇒ ★★★若 food 普遍 glut,【農隊賣糧收入歸零】= 真正的 regime change
        —— 而那正是「先治上游」要防的病
   下界命中率【低】⇒ 直接拆
