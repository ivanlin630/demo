...
狀態：★**T1／T4 已落地、R² CLEAN（見 §5）；★★T2 只落到部分床，`qty_tap_bed` 漏做 → 2026-08-27 補派。**

> ★★★**狀態欄訂正 2026-08-27（systems）**：~~待 R² → dispatch。下輪長考前置~~ ——
> ★**它從 2026-08-20 起就是錯的**：R² 當天判 CLEAN（§5 就寫在下面），T1／T4 也已進 code。
> ★★**而這個假狀態害我 2026-08-27 差點重寫一份【已經存在且已落地】的 spec**，
> 並且讓「T4 已經在替我們看門」這件事對所有人隱形了七天。
> ★★★**通則：狀態欄說謊比沒有狀態欄更糟** —— **沒有狀態欄的人會去查，看到假狀態的人不會。**
