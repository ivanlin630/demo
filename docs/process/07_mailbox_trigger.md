...
★★★**為什麼是【先寫檔、後敲門】這個順序**（2026-09-23 血證：一封只用 SendMessage 送的信**被 relay 丟掉**）：
   **敲門會掉，檔案不會** ⇒ ★git handback 是【耐久的那一半】，敲門只是【喚醒的那一半】。
   ⇒ ★★**禁止只敲門不寫檔** —— 那等於把整封信放在一個沒有重送的通道上。
   ⇒ ★★★而它是「落地≠通知」的**反面**：**通知了 ≠ 送到**。兩個方向都要防，而防法是同一個：
     **讓那件事在一個【事後查得到】的地方留下痕跡。**
