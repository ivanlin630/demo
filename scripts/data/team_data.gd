...
# ★L3 循環貿易 perf：has_market_visit_value cadence 快取（visit-util 掃含 vision-harvest 昂貴、禁每 gather 算）。
var market_visit_cached: bool = false
var market_visit_next_tick: int = 0
