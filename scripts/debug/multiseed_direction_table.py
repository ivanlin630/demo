...
def main():
    ...
    print("")
    print("★★★本表每一格都是【兩趟之間的差】⇒ **全部要多 seed 才能講**；")
    print("   ★而【一趟裡的比例】（例：迎戰 736 次只打 1 次、碰到了但沒開打 60.1%）**不在本表**，")
    print("   ★★而它們【不怕蝴蝶】 —— 判法是問：這個數字是一趟裡的組成，還是兩趟之間的差（systems 2026-09-15）。")
...
CONFUSABLES = {0x8DA1: 0x8D9F, 0x8DA0: 0x8D9F, 0x8FF4: 0x8FCE}   # ★第六次打錯時才發現還有第二個鄰居
